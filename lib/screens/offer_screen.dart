...
import 'package:dreamflow/widgets/gamezop_banner.dart';
import 'package:dreamflow/widgets/app_header.dart';
...
class _OfferScreenState extends State<OfferScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _openOfferLink() async {
    ...
    final Uri url = Uri.parse('https://getsfree.site/');
